...
const english = {
  ...
  formatting: 'Text Formatting', currentFormat: 'Text Appearance', editContent: 'Edit Content', placeholder: 'Select a region first',
  ...
  tessInit: 'Initializing OCR Engine...', tessReady: 'OCR Engine Ready', presetFonts: 'Font Settings', presetFontFamilyGroup: 'Font Family', presetFontStyleGroup: 'Text Style',
  engFont: 'English/Number Font', zhFont: 'Chinese/System Font', fontSize: 'Font Size', forceFont: 'Force Preset Font on Image/OCR Load',
  applyPresetFontFamily: 'Apply font family',
  applyPresetFontFamilyHelp: 'Includes the English/number and Chinese/system font selections.',
  applyPresetTypography: 'Apply size and emphasis',
  applyPresetTypographyHelp: 'Includes font size, bold, and italic settings.',
  liveAppearanceAdjustments: 'Live appearance',
  applyContentSelection: 'Apply content',
  formatApplyActions: 'Apply formatting',
  ...
  presetFontWorkflowStep4: 'Force preset font on Image/OCR Load is off by default; enable it only when OCR output should immediately use the selected font family. OCR still preserves estimated source size and color.',
  ...
  fontApplyOptionsRequired: 'Choose at least one formatting group to apply.',
...
const traditionalChinese = {
  ...
  formatting: '文字格式設定', currentFormat: '文字外型設定', editContent: '編輯內容', placeholder: '請先選擇一個文字區塊', placeholderActive: '在此修改文字內容...', paragraph: '段落格式', bold: '粗體', italic: '斜體',
  ...
  presetFonts: '字型設定', presetFontFamilyGroup: '字型家族', presetFontStyleGroup: '文字樣式', engFont: '英文/數字字型', zhFont: '中文/系統字型', fontSize: '字體大小', forceFont: '圖片載入/OCR 後強制套用預設字型', applyFontAllPreset: '套用字型至全檔',
  applyPresetFontFamily: '套用字型',
  applyPresetFontFamilyHelp: '包含英文/數字字型與中文/系統字型兩組選擇。',
  applyPresetTypography: '套用字級與粗斜體',
  applyPresetTypographyHelp: '包含字體大小、粗體與斜體設定。',
  liveAppearanceAdjustments: '即時外觀調整',
  applyContentSelection: '套用內容勾選',
  formatApplyActions: '快速套用',
  ...
  presetFontWorkflowStep4: '「圖片載入/OCR 後強制套用預設字型」預設關閉；啟用後只會套用字型家族，OCR 仍會保留依原圖估算的字級與顏色。',
  fontAppliedSelected: '已將字型與文字格式套用到目前文字區塊。',
  fontAppliedAll: '已將字型與文字格式套用到所有文字圖層。',
  fontApplyOptionsRequired: '請至少勾選一組要套用的文字格式。',
