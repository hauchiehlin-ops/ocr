...
const english = {
  ...
  singleWordAdjustMode: 'Single-word adjustment mode',
  singleWordAdjustHelp: 'Select a text block to enter inline editing immediately while keeping its original box and styling.',
  singleWordAdjustHint: 'Single-word adjustment mode: click the target text block and edit it in place.',
...
const traditionalChinese = {
  ...
  singleWordAdjustMode: '單字微調模式',
  singleWordAdjustHelp: '選取文字區塊後會直接進入原地編修，保留原本文字框與格式，適合只改少數字詞。',
  singleWordAdjustHint: '單字微調模式：點選要修改的文字區塊後，直接在原位編修。',
