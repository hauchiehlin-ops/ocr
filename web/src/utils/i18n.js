...
const english = {
  ...
  formatting: 'Text Formatting', currentFormat: 'Text Format Now', editContent: 'Edit Content', placeholder: 'Select a region first',
  ...
  tessInit: 'Initializing OCR Engine...', tessReady: 'OCR Engine Ready', presetFonts: 'Preset Fonts', presetFontFamilyGroup: 'Font Family', presetFontStyleGroup: 'Text Style',
...
const traditionalChinese = {
  ...
  formatting: '文字格式設定', currentFormat: '文字現況格式', editContent: '編輯內容', placeholder: '請先選擇一個文字區塊', placeholderActive: '在此修改文字內容...', paragraph: '段落格式', bold: '粗體', italic: '斜體',
  ...
  presetFonts: '預設字型與格式設定', presetFontFamilyGroup: '字型家族', presetFontStyleGroup: '文字樣式', engFont: '英文/數字字型', zhFont: '中文/系統字型', fontSize: '字體大小', forceFont: '圖片載入/OCR 後強制套用預設字型', applyFontAllPreset: '套用字型至全檔',
