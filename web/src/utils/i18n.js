...
const traditionalChinese = {
  ...
  presetFonts: '預設字型與格式設定', presetFontFamilyGroup: '字型家族', presetFontStyleGroup: '文字樣式', engFont: '英文/數字字型', zhFont: '中文/系統字型', fontSize: '字體大小', forceFont: '圖片載入/OCR 後強制套用字型與格式', applyFontAllPreset: '套用字型至全檔',
